...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('public/images/hero_bg_2.jpg');">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ asset('public/images/person_1.jpg') }}" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ asset('public/images/person_2.jpg') }}" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ asset('public/images/person_3.jpg') }}" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="{{ asset('public/images/person_4.jpg') }}" alt="Image placeholder" class="mb-4">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            ...
            <div class="block-7">
              <h3 class="footer-heading mb-4">About <strong class="text-primary">MEDSHOP
