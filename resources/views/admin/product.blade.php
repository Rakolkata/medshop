                 ...
                 <div class="col-md-12">
                  ...
                  <div class="col-sm-4">
                   <label for="qnty">Quantity<span style="color:red;">*</span></label>
                     <input  type="text"  id="quantity"  class="typeahead  form-control form-control"  name="quantity" required placeholder="Enter qnty">
                      
                  </div>
                  <div class="col-sm-4">
                   <label for="price">Price<span style="color:red;">*</span></label>
                     <input  type="text"  id="price"  class="typeahead  form-control form-control"  name="price" required placeholder="Enter price">
                      
                  </div>
                  <div class="col-sm-4">
                   <label for="sellPrice"> Sell Price<span style="color:red;">*</span></label>
                     <input  type="text"  id="sellPrice"  class="typeahead  form-control form-control"  name="sellPrice" required placeholder="Enter  Selling price">
