...
<h6 class="p-2"><span style="border-bottom: 1px solid #60b5ba">Update Function</span></h6>
...
<div>
<button class="btn text-white mt-1" style="background-color:#60b5ba">Submit</button>
</div>
</form>
</div>
@endsection