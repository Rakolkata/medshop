    ...
    <tbody class="text-capitalize" id="order">
      ...
      <tr>
        ...
        <td>
          ...
          <a class="btn_pdf" id="{{$loop->iteration}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 20px"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
