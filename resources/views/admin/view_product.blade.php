  ...
  <div class="col-md-6">
    ...
    <form action="" method="get">
      <div class="input-group flex-nowrap mb-3 p-2" style="background-color: #60b5ba">
        ...
        <a class="btn  text-white" href="{{route('admin.view_product')}}" id="reset">Reset</a>
      </div>
    </form>
  ...
  <table class="table table-striped text-capitalize table-responsive-sm" style="width:100%">
    ...
    <tbody>
      ...
      <td>
        ...
        <td>
        <a href="{{route('admin.delete_product',['id'=>$item->id,'page'=>$product->currentpage()])}}" onclick="return confirm('Are you sure you want to delete this product?')"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="height: 20px"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
    ...
    if (results.length > 0) {
      ...
      results.forEach(function(item) {
       ...
       '<path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>' +
        ...
        var baseUrl = "{{ route('admin.delete_product', ['id' => ':id', 'page' => ':page']) }}";
        deleteLink.href = baseUrl.replace(':id', id).replace(':page', currentPage);
        ...
        deleteLink.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="height: 20px">' +
          '<path fill="red" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/>' +
        '</svg>';
        deleteLink.setAttribute("onclick", "return confirm('Are you sure you want to delete this product?')");
