...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{ route('welcome')}}">Home</a> <span class="mx-2 mb-0">/</span> <a
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="{{ asset('public/images/product_07_large.png') }}" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
