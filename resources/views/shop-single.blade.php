    ...
    <div class="py-2">
        <div class="row">
          <div class="col-md-12 mb-0" style="background-color: #b9dded;">
                <span class="mx-2 mb-0"> <strong class="text-black">{{ Session::get('success') }}</strong></span>
          </div>
      </div>
    </div>  
    @endif
        ...
        <div class="row">          
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="{{asset('/storage/app').'/'.$product->image }}" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">{{$product->gematricName}}</h2>
            <p>{{$product->title}}</p>
