          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                ...
                <p><a href="{{ route('shop') }}" class="btn btn-primary px-5 py-3">Shop Now</a></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12 block-3 products-wrap">
            <div class="nonloop-block-3 owl-carousel">
             ...
             @foreach ($productlist as $row) <div class="text-center item mb-4 item-v2">
                ...
                <a href="{{ route('shop-single').'/'.$row->id }}"> <img src="{{asset('/storage/app').'/'.$row->image }}" alt="Image" height="330px" width="90px"></a>
                <h3 class="text-dark"><a href="{{ route('shop-single').'/'.$row->id }}">{{$row->gematricName}}</a></h3>
